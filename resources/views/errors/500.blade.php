<x-layouts.public title="Error 500 – Error del Servidor">
    <section class="relative flex min-h-[80vh] items-center justify-center overflow-hidden bg-secondary py-20">
        ...
        {{-- Decorative Elements --}}
        <div class="absolute -left-32 -top-32 h-64 w-64 rounded-full bg-red-600/10 blur-3xl"></div>
        <div class="absolute -bottom-20 -right-20 h-80 w-80 rounded-full bg-orange-600/10 blur-3xl"></div>

        <div class="relative z-10 mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
            <h1 class="font-display text-[150px] font-black leading-none text-transparent bg-clip-text bg-gradient-to-br from-red-600 to-red-400 drop-shadow-lg md:text-[200px]">
                500
            </h1>
            ...
            <div class="mt-4 mb-8 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-5 py-2 backdrop-blur-md">
                ...
                <span class="text-sm font-bold text-white">El programador</span>
            </div>
            ...
            <p class="mx-auto mt-6 max-w-xl text-lg text-neutral-400 leading-relaxed">
                Nuestros ingenieros de software acaban de reportar una falla estructural en el servidor. Estamos trabajando duro para repararlo lo antes posible.
            </p>
            
            <div class="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
                <button onclick="window.location.reload()" class="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-red-600 to-red-500 py-4 px-8 font-bold text-white shadow-xl shadow-red-500/25 transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/40 hover:scale-[1.02] sm:w-auto">
                    <span class="relative z-10 flex items-center justify-center gap-2">
                        <span class="material-symbols-outlined text-xl">refresh</span>
                        Reintentar
                    </span>
                    <div class="absolute inset-0 bg-gradient-to-r from-red-500 to-red-600 opacity-0 transition-opacity group-hover:opacity-100"></div>
                </button>
