<x-layouts.public title="Error 404 – Página no encontrada">
    <section class="relative flex min-h-[80vh] items-center justify-center overflow-hidden bg-secondary py-20">
        ...
        <div class="relative z-10 mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <div class="mt-4 mb-8 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-5 py-2 backdrop-blur-md">
                ...
                <span class="text-sm font-bold text-white">Tú / El enlace</span>
            </div>
            ...
            <p class="mx-auto mt-6 max-w-xl text-lg text-neutral-400 leading-relaxed">
                Parece que te has perdido en el sitio de construcción. La página que estás buscando no existe o ha sido movida a otra dirección.
            </p>
            ...
            <div class="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="{{ url()->previous() !== url()->current() ? url()->previous() : url('/') }}" class="inline-flex h-[56px] w-full items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/5 px-8 font-bold text-white backdrop-blur-sm transition-all hover:bg-white/10 hover:border-white/30 sm:w-auto">
