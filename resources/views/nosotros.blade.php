<x-layouts.public title="Nosotros – Indago Constructora | Ingeniería & Arquitectura en RD">
    ...
    <section id="infra-stats" class="py-24 bg-neutral-100">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                @php
                    $maquinaria = [
                        ['img' => asset('img/excavadora.png'), 'nombre' => 'Excavadoras Hidráulicas', 'desc' => '6 unidades Cat 320 y 336', 'icon' => 'construction'],
                        ['img' => asset('img/Camionesvolquetes.png'), 'nombre' => 'Camiones Volquetes', 'desc' => '12 unidades de alto tonelaje', 'icon' => 'local_shipping'],
                        ['img' => asset('img/Gruatorre.png'), 'nombre' => 'Grúas Torre', 'desc' => '4 grúas para proyectos verticales', 'icon' => 'precision_manufacturing'],
                        ['img' => asset('img/NiveladorasyCompactadoras.png'), 'nombre' => 'Niveladoras y Compactadoras', 'desc' => '8 unidades para preparación de terreno', 'icon' => 'layers'],
                        ['img' => asset('img/PlataformasAndamios.png'), 'nombre' => 'Plataformas y Andamios', 'desc' => 'Sistema modular certificado EU', 'icon' => 'foundation'],
                        ['img' => asset('img/LaboratoriodeMateriales.png'), 'nombre' => 'Laboratorio de Materiales', 'desc' => 'Control de calidad en obra in situ', 'icon' => 'science'],
                    ];
                @endphp
    ...
    <section class="py-24 bg-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-8 sm:grid-cols-2 max-w-3xl mx-auto">

                @php
                    $equipo = [
                        ['nombre' => 'Laura Elisa Gomez Mota', 'cargo' => 'Arquitecta | Gerente Administrativa',    'img' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuCjyRgwfDbCRtl8Yy2SCRczQ4aZkCLvcwQOR9s1ALRUZuIovvE7lEvIl1YSPUt3EshBiqJK2w1Q-XecQLsU0NvVq3InpguGm7Vu7kaeDXG1ev0JkNdPA80AK4prnIamHMoyOOrHV6JyVBDBG_8YRYv3Z0mTFTNgMsyk0WlhEhjIwZtHzfylYaiVtfJZassh2gk6QhR8mphf0c0Wkz2CsVwSSdhwR5EVaLlJRZrGfPp_vHd-nUTh6ZaZZd2Hy3G2zJrZxvWSo1TfmHs', 'linkedin' => '#'],
                        ['nombre' => 'Analdo Andres Indalecio De La Rosa',   'cargo' => 'Ingeniero Civil | Gerente General',              'img' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuCVvpXvUKpHDaWrd8KTYho9VV4SBUS9DqqdJF_qVVcfuGwXSvawfVbnsCGwngDoBgpnq8PtSMQca01MzIRUFKyoPaGYf8FwgaqrKPIA6jd3wd4QKaNs1i-HJOkU4Ud36hjiEWawsoJCvBXS4uktmfNfj1vwvwJ3kbu4rTAnLrbfQ0f7sKMoo2Mxwb7fJ0lGykv1Xid_O-T9aSPGBqGQiZhsjoccGLwFvgx26PiUgGqQBuv5sEY55nulM4I69EcB6e3I3r3fgYAjNFA', 'linkedin' => '#'],
                    ];
                @endphp
